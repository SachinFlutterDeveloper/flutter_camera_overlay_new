...
class _ScanCardScreenState extends State<ScanCardScreen> {
  ...
  Future<void> fetchCardTypes() async {
    ...
    _cardTypes = await homeViewModel.fetchCardTypes();
    setState(() {});
  }
                      ...
                      children: [
                        ...
                        Padding(
                            ...
                            child: DropdownButtonFormField<String>(
                                ...
                                value: selectedItem,
                                items: _cardTypes.map<DropdownMenuItem<String>>(
                                  (String value) {
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            enabled:
                                defaultUser.toLowerCase() != 'for personal use',
                      ...
                      child: CupertinoButton(
                        ...
                        onPressed: () async {
                          ...
                          if (selectedItem == null || selectedItem!.isEmpty) {
                            ...
                            Utils.snackBarMessage(
                                'Please add front scan of your card', context);
                            ...
                            Utils.snackBarMessage('Please Enter Name', context);
...
InputDecoration buildInputDecoration(BuildContext context, String hint) {
  return InputDecoration(
    hintText: hint,
    hintStyle: TextStyle(fontSize: 16 / MediaQuery.of(context).textScaleFactor),
